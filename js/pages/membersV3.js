...
export class MembersController {
    ...
    showMemberDetails(member) {
        ...
        this.elements.modalBody.innerHTML = `
            <div class="member-details">
                <div class="member-section">
                    <h4 class="member-section-title">Basic Information</h4>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">${this.getStatusBadge(member.status)}</div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Join Date:</div>
                        <div class="detail-value">${member.joinDate ? new Date(member.joinDate).toLocaleDateString() : 'N/A'}</div>
                    </div>
                </div>

                <div class="member-section">
                    <h4 class="member-section-title">Contact Information</h4>
                    <div class="detail-row">
                ...
                ${member.notes ? `
                <div class="member-section">
                    <h4 class="member-section-title">Additional Information</h4>
                    <div class="detail-row">
        ...
        this.elements.modalFooter.innerHTML = `
            <button class="action-btn edit" id="edit-member" title="Edit"><i class="fas fa-edit"></i> Edit</button>
            <button class="action-btn view" id="close-modal" title="Close"><i class="fas fa-times"></i> Close</button>
        `;
    ...
    showMemberForm(member = null) {
        ...
        this.elements.modalFooter.innerHTML = `
            ...
            <button class="action-btn danger" id="cancel-form" title="Cancel"><i class="fas fa-times"></i> Cancel</button>
        `;
